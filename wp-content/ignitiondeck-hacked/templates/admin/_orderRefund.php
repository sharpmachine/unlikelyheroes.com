	...
	<form id="Form1" name="Form1" action="RefundReceipt.php" method="post">
		...
		<table width="100%">
			...
			<tr>
				...
				<td><input class="submitbtn" type="hidden" name="receiveremail" size="50" value="<?php=$paypal_settings->paypal_email?>"></td>
				<td width="4%"><input type="hidden" name="amount" size="5" maxlength="7" value="<?php=$product_data->product_price?>"></td>
			</tr>
			<tr>
