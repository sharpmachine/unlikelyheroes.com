					...
					<div class="inside">
						<form name="formSettings" action="" method="post">
							<ul>
								...
								<strong><?php echo $tr_Social_Settings; ?></strong><br/>
								<a href="#" id="check-all-settings">Check All</a>&nbsp;<a href="#" id="clear-all-settings">Clear All</a>
								<li>
									
									<div><input <?php echo (isset($data) && $data->prod_page_fb == 1 ? 'checked="checked"' : ''); ?> name="prod_page_fb" type="checkbox" id="prod_page_fb" class="main-setting" value="1" /> 				<label for="prod_page_fb"><img src="<?php echo plugins_url('/images/help/facebook.png', dirname(dirname(__FILE__))); ?>"><?php echo $tr_Facebook_Product_Page; ?></label>
									<a href="javascript:toggleDiv('hFB');" class="idMoreinfo">[?]</a>
									<div id="hFB" class="idMoreinfofull"><img src="<?php echo plugins_url('/images/help/fblike.jpg', dirname(dirname(__FILE__))); ?>"><?php echo $tr_people_share_Facebook_Product; ?></span>
									</div>
									</div>
								</li>
								<li>
									<div><input <?php echo (isset($data) && $data->prod_page_twitter == 1 ? 'checked="checked"' : ''); ?> name="prod_page_twitter" type="checkbox" id="prod_page_twitter" class="main-setting"value="1" />
									<label for="prod_page_twitter"><img src="<?php echo plugins_url('/images/help/twitter.png', dirname(dirname(__FILE__))); ?>"><?php echo $tr_Twitter_Product_Page; ?></label>
									<a href="javascript:toggleDiv('hTwit');" class="idMoreinfo">[?]</a>
									<div id="hTwit" class="idMoreinfofull"><img src="<?php echo plugins_url('/images/help/tweet.jpg', dirname(dirname(__FILE__))); ?>"><?php echo $tr_people_share_Twitter_Product; ?>
									</div>
									</div>
								</li>
								<li>
									<div><input <?php echo (isset($data) && $data->prod_page_adn == 1 ? 'checked="checked"' : ''); ?> name="prod_page_adn" type="checkbox" id="prod_page_adn" class="main-setting" value="1" />
									<label for="prod_page_adn"><img src="<?php echo plugins_url('images/help/ADN-wp.png', dirname(dirname(__FILE__))); ?>" style="width: 16px; height: 16px;"/><?php echo $tr_ADN_Product_Page; ?></label>
									<a href="javascript:toggleDiv('hAdn');" class="idMoreinfo">[?]</a>
									<div id="hAdn" class="idMoreinfofull"><img src="<?php echo plugins_url('/images/help/ADN-post-btn.png', dirname(dirname(__FILE__))); ?>"/><?php echo $tr_people_share_ADN_Product; ?>
									</div>
									</div>
								</li>
								<li>
									
									<div><input <?php echo (isset($data) && $data->prod_page_linkedin == 1 ? 'checked="checked"' : ''); ?> name="prod_page_linkedin" type="checkbox" id="prod_page_linkedin" class="main-setting" value="1" />
									<label for="prod_page_linkedin"><img src="<?php echo plugins_url('/images/help/linkedin.png', dirname(dirname(__FILE__))); ?>"><?php echo $tr_LinkedIn_Product_Page; ?></label>
									<a href="javascript:toggleDiv('hLinked');" class="idMoreinfo">[?]</a>
									<div id="hLinked" class="idMoreinfofull"><?php echo $tr_people_share_LinkedIn_Product; ?></span>
									</div>
									</div>
								</li>
								<li>
									<div><input <?php echo (isset($data) && $data->prod_page_google == 1 ? 'checked="checked"' : ''); ?> name="prod_page_google" type="checkbox" id="prod_page_google" class="main-setting" value="1" />
									<label for="prod_page_google"><img src="<?php echo plugins_url('/images/help/google-plus.png', dirname(dirname(__FILE__))); ?>"><?php echo $tr_Google_Product_Page; ?></label>
									<a href="javascript:toggleDiv('hGoog');" class="idMoreinfo">[?]</a>
									<div id="hGoog" class="idMoreinfofull"><?php echo $tr_people_share_Google_Product; ?>
									</div>
									</div>
								</li>
								<li>
									
									<div><input <?php echo (isset($data) && $data->prod_page_pinterest == 1 ? 'checked="checked"' : ''); ?> name="prod_page_pinterest" type="checkbox" id="prod_page_pinterest" class="main-setting" value="1" /> 				<label for="prod_page_pinterest"><img src="<?php echo plugins_url('/images/help/pinterest.png', dirname(dirname(__FILE__))); ?>"><?php echo $tr_Pinterest_Product_Page; ?></label>
									<a href="javascript:toggleDiv('hPinterest');" class="idMoreinfo">[?]</a>
									<div id="hPinterest" class="idMoreinfofull"><?php echo $tr_people_share_Pinterest_Product; ?></span>
									</div>
									</div>
								</li>
