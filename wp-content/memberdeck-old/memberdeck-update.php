...
add_filter('pre_set_site_transient_update_plugins', 'check_for_md_update');

function check_for_md_update($checked_data) {
...
add_filter('plugins_api', 'md_api_call', 10, 3);

function md_api_call($def, $action, $args) {
