...
* Image Left Widget
*/
class Fh_Content_Image_Left_Widget extends WP_Widget {
	/**
	* Register widget with WordPress
	*/
	function __construct() {
		parent::__construct(
			'fh_content_image_left_widget',
			__('500 Content Image Left Widget', 'fivehundred'),
			array('description' => __('Left image with headline and text to the right', 'fivehundred')),
			array('width' => 400));
	}
	/**
	...
	function widget($args, $instance) {
		if (!empty($instance)) {
			...
			echo '<div class="ign-content-normal imageleft cf '.$custom_class.'"><img src="'.$image.'">';
			echo '<h3>'.$title.'</h3>';
