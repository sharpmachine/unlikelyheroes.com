<?php
/**
* Background Image Left Widget
*/
class Fh_Content_Background_Left_Widget extends WP_Widget {
	/**
	* Register widget with WordPress
	*/
	function __construct() {
		parent::__construct(
			'fh_content_background_left_widget',
			__('500 Content Background Left Widget', 'fivehundred'),
			array('description' => __('Left background image with headline and text to the right', 'fivehundred')),
			array('width' => 400));
	}
	/**
	...
	function widget($args, $instance) {
		if (!empty($instance)) {
			...
			echo '<div class="ign-content-normal bg_imageleft cf '.$custom_class.'" style="background-image: url('.$image.'); padding-top:'.$padding_top.'px; padding-bottom:'.$padding_bottom.'px; color:'.$text_color.' !important;">';
			echo '<h3>'.$title.'</h3>';
