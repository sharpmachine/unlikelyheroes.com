...
if ($settings->prod_page_adn) {
	//$post_output .= '<div style="float:right;"><a href="http://twitter.com/share" target="_new" class="twitter-share-button button twitter" data-count="vertical">tweet</a></div>';
	echo '<div id="share-adn" class="social-share social-button"><a href="#" class="" onclick="postADN();"><img src="'.plugins_url('/ignitiondeck/images/help/ADN-post-btn.png').'"/></a>
...
if ($settings->prod_page_linkedin) {
...
if ($settings->prod_page_pinterest) {
...
?>
<div id="share-embed" class="social-share hidden"><i class="icon-code"></i> Embed</div>
